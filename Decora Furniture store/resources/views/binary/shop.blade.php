...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        @include('binary/includes/mobile_nav_other')
        ...
        @include('binary/includes/header_area_first')
            ...
            <nav class="amado-nav">
                <ul>
                    <li><a href="{{url('binary/home')}}">Home</a></li>
                    <li class="active"><a href="{{url('binary/shop')}}">Shop</a></li>
                        ...
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    <a href="{{url('binary/product-details')}}">
                                        <h6>Modern Chair</h6>
                                    </a>
                                </div>
                                <!-- Ratings & Cart -->
                                <div class="ratings-cart text-right">
                                    ...
                                    <div class="cart">
                                        <a href="{{url('binary/cart')}}" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="img/core-img/cart.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
